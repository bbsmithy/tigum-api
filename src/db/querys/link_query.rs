...
pub async fn delete_link(conn: &TigumPgConn, id: i32, user_id: i32) -> ApiResponse {
...
pub async fn update_link(conn: &TigumPgConn, id: i32, link: Json<NewLink>, user_id: i32) -> ApiResponse {
    let update = conn.run(move |c|
        c.query(
...
pub async fn get_link(conn: &TigumPgConn, id: i32, user_id: i32) -> ApiResponse {
    let query_result = conn.run(move |c|
        c.query(
...
pub async fn create_link(conn: &TigumPgConn, link: Json<NewLink>, user_id: i32) -> ApiResponse {
