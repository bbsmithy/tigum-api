...
pub async fn update_article_snippet(
    conn: &TigumPgConn,
    id: i32,
...
pub async fn get_article_snippet(conn: &TigumPgConn, id: i32, user_id: i32) -> ApiResponse {
    let query_result = conn.run(move |c|
...
pub async fn create_article_snippet(
    conn: &TigumPgConn,
    article_snippet: Json<NewArticleSnippet>,
    user_id: i32
) -> ApiResponse {
